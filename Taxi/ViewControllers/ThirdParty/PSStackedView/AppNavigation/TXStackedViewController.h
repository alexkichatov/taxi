...
@interface TXStackedViewController : UIViewController
...
/// event delegate
@property(nonatomic, weak) id<TXStackedViewDelegate> delegate;
...
/// pan gesture recognizer used
@property(nonatomic, strong) UIPanGestureRecognizer *panRecognizer;

/// enable if you show another object in full screen, but stacked view still thinks it's displayed
/// reduces animations to a minimum to get smoother reactions on front most view.
...
/// Property to disable dragging past left insets, recommend setting enableBounces to NO when this is set to NO
...
/// left inset that's always visible. Defaults to 60.
